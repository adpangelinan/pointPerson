...
CREATE TABLE `paymentcards` (
  `paymentcards_id` int NOT NULL,
  `card_number` varchar(45) NOT NULL,
  `billing_address` varchar(45) NOT NULL,
  `card_person_name` varchar(45) NOT NULL,
  `card_user` int NOT NULL,
  PRIMARY KEY (`paymentcards_id`),
  KEY `card_user` (`card_user`),
  CONSTRAINT `card_user` FOREIGN KEY (`card_user`) REFERENCES `user_profiles` (`user_id`)
